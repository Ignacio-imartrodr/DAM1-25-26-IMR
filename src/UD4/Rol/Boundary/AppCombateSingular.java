...
public class AppCombateSingular {//TODO añadir y refactorizar cosas
    ...
    public static void main(String[] args) {
        ...
        if (personajesCreados.length > 2) {
            personajesEnBatalla = Combate.seleccionarPersonajes(personajesCreados, 2);
        ...
        while (batalla) {//TODO agregar efectos armaduura y armas
            boolean turno;
            ...
            boolean dosHobbit = personajesEnBatalla[0].getRaza().equals(Raza.HOBBIT)
                    && personajesEnBatalla[1].getRaza().equals(Raza.HOBBIT);
            ...
            while (personajesEnBatalla[0].estaVivo() && personajesEnBatalla[1].estaVivo()) {
                ...
                while (accionNoValida) {
                    ...
                    System.out.println("¿Qué va a hacer? [ 1 - Atacar | 2 - Curar | 3 - "
                            + personajeActuando.stringHabilidadRaza() + " | 4 - Abrir bolsa | 5 - Huir ]");
                    ...
                    switch (Integer.parseInt(accion)) {
                        case 1:
                            ...
                            if (xp == 0) {
                                ...
                                System.out.println(
                                        "El personaje \"" + enemigo.getNombre() + "\" recibió " + xp + " de daño!");
                            }
                        ...
                        case 4:
                            ...
                            System.out.println(
                                    "Escoge Objeto (número de la izquierda) u otro número para cambiar de opción: ");
                            accion = Util.pedirPorTeclado(true);
                            ...
                            accion = bolsa.substring(ubNomObjetoPos,
                                    ubNomObjetoPos + bolsa.substring(ubNomObjetoPos).indexOf(" ("));
                            try {
                        ...
                        case 5:
                            ...
                            System.out
                                    .println("\"" + personajeActuando.getNombre() + "\" ha huido del enfrentamiento!");
                            accionNoValida = false;
                            break;
                        default:
                ...
                turno = Combate.cambiarTurno(turno);
            }
            System.out
                    .println("\nEl ganador es " + (personajesEnBatalla[0].estaVivo() ? personajesEnBatalla[0].toString()
                            : personajesEnBatalla[1].toString()));
            ...
            if (Util.escogerOpcion("S", "n")) {
                ...
                while (personajesEnBatalla[0] == null || personajesEnBatalla[1] == null) {
                    System.out.println(
                            "No hay suficientes personajes para la batalla, selecciona al menos 2 personajes.");
                    personajesEnBatalla = Combate.seleccionarPersonajes(personajesCreados, 2);
                }
            } else {
                batalla = false;
